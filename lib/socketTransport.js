...
class MaxSocketTransport {
  ...
  /**
   * Второй фактор: пароль 2FA после успешного кода из SMS (см. ответ AUTH с passwordChallenge).
   * Тело как в клиенте Max: trackId + password, opcode AUTH_LOGIN_CHECK_PASSWORD (0x73).
   */
